...
def test_get_project_tasks_returns_nested_tasks(
    client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
    sample_project: Project,
) -> None:
    async def fake_get_project_with_tasks(_: object, __: int) -> Project:
        return sample_project

    monkeypatch.setattr(project_crud, "get_project_with_tasks", fake_get_project_with_tasks)
